...
while True:
    ...
    print("2. Pies a Millas ")
    print("3. Cm a Yardas")
    print("4. Galones a Litros")
    print("5. km/h a m/s ")
    print("6. cm2 a m2")
    print("7. mill/h  a  pies/seg")
    print("8. pesos Mex a Dlls")
    print("9. Pie a Pulgada")
    print("10. Celsius a Fahrenheit ")
    print("11. Salir")
    ...
    if opcion == "1":
        ...
        print("{} Metros equivalen a: {} ft".format(metros, opp1(metros)))
        input()
        os.system("clear")
        ...
        print("{} Pies equivalen a: {} Millas".format(pies, opp2(pies)))
        input()
        os.system("clear")
        ...
        print("{} Cm equivalen a: {} Yardas".format(cm, opp3(cm)))
        input()
        os.system("clear")
        ...
        print("{} Galones equivalen a: {} Lts".format(galones, opp4(galones)))
        input()
        os.system("clear")
        ...
        print("{} Km/h equivalen a: {} M/s".format(kmh, opp5(kmh)))
        input()
        os.system("clear")
        ...
        print("{} Cm2 equivalen a: {} m2".format(cmc, opp6(cmc)))
        input()
        os.system("clear")
        ...
        print("{} Millas/h equivalen a: {} Pies/seg".format(mill_h, opp7(mill_h)))
        input()
        os.system("clear")
        ...
        print("{} Pesos equivalen a: {} Dlls".format(pesos, opp8(pesos)))
        input()
        os.system("clear")
        ...
        print("{} Pies equivalen a: {} Pulgadas".format(pies, opp9(pies)))
        input()
        os.system("clear")
        ...
        print("{} Celsius equivalen a: {} Fahrenheit".format(celsius, opp10(celsius)))
        input()
        os.system("clear")
